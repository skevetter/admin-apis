...
// Announcement contains an announcement that should be shown within the Devsy instance.
// This information is sent to Devsy instances when they check in with the license server.
